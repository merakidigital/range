...
<body class="bg-white ">
    <section id="section-1" class="my-5 ">
        <div class="text-center">
            ...
            <label>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quibusdam, praesentium quasi.</label>
        </div>
    </section>
    <section class="mt-2">
        <div class="row">
            <div class="imagen col-12 col-sm-4 text-center">
                <img class="rounded-circle" src="./assets/imgs/perfil.jfif">
    ...
    <section class="my-4">
        <div class="row mb-4 degradado pt-5">
            ...
            <div class="col-12 col-sm-6">
                <div class="flex flex-column justify-content-center h-100 align-items-center px-5 p-sm-0">
